  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Una web para ayudarte a organizar y gestionar tu huerta familiar y sus cultivos de la forma más rápida y cómoda."
        />
            ...
            <div className="mb-12 lg:max-w-lg lg:pr-5 lg:mb-0">
              <div className="max-w-xl mb-6">
                ...
                <p className="text-base md:text-lg text-gray-700">
                  <strong>Huella Verde</strong> es una web para ayudarte a
              ...
              <div className="flex text-gray-700">
                Puedes administrar y medir la temperatura de los huertos, regar las plantas, automatizar tareas y mucho más.
              </div>
            </div>
